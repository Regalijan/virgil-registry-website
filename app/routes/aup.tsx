  ...
  return (
    <Container maxW="container.md" pb="100px" textAlign="left">
      ...
      <ul style={{ fontSize: "large" }}>
        <li>
          <b>Only use your own account</b>: In the event that we receive notice
          of a stolen account, you will be permanently banned from the registry.
        </li>
        <br />
        <li>
          <b>Respect the privacy of other users</b>: Do not use the registry to
          stalk or otherwise track other users.
        </li>
        <br />
        <li>
      ...
      <ul style={{ fontSize: "large" }}>
        <li>
          ...
          requests for the sake of making them may get you blocked from the API,
          repeat offenders will be permanently banned from accessing the API.
        </li>
        <br />
        <li>
          <b>Do not attempt to bypass access restrictions</b>: Users expect the
          privacy settings they choose are accurate. Do not attempt to
          circumvent user privacy settings or otherwise bypass any restrictions
          on the API.
        </li>
        <br />
        <li>
